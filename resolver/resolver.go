...
func (r *Resolver) VisitDictExpr(v *ast.DictExpr) (result interface{}, err error) {
	return
}

func (r *Resolver) VisitListExpr(v *ast.ListExpr) (result interface{}, err error) {
	return
}

func (r *Resolver) VisitIndexExpr(v *ast.IndexExpr) (result interface{}, err error) {
	return
}
